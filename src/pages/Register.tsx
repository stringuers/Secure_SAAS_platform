  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: error.message || "Could not create account. Make sure backend is running.",
        variant: "destructive"
      });
    } finally {
      setLoading(false);
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <Card className="relative w-full max-w-md p-8 bg-card/95 backdrop-blur border-border">
        ...
        <div className="flex flex-col items-center mb-8 mt-8">
          ...
          <p className="text-muted-foreground mt-2">Join the security demo platform</p>
        </div>
          ...
          <div className="bg-secondary/50 border border-border rounded-lg p-3 text-sm">
            <div className="flex items-start gap-2">
              ...
              <div className="text-muted-foreground">
                Your password will be hashed with bcrypt before storage. HTTPS ensures encrypted transmission.
              </div>
            </div>
          </div>
